...
/**
  ...
  *
  * Die Zahl des Spielsteins wird in die Mitte des Steins geschrieben.
  *
  * @param  row Die Nummer der Zeile des Felds (row == 0 : oberste Zeile)
  * @param  col Die Nummer der Spalte des Felds (col == 0 : linke Spalte)
